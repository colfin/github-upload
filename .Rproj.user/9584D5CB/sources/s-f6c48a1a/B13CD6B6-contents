...
#define custom colors for Colin's plot:
                           ...
                           tabPanel("National Park Service Visitation",
                                    sidebarLayout(
                                        sidebarPanel(width=5, #out of 12 units
                                                     ...
                                                     p ("In the top panel, COVID-19 outcomes (cases per 100,000, deaths per 100,000, confirmed cases, and deaths) in Wyoming counties with National Park Service (NPS) units are averaged and plotted against averaged outcomes from Wyoming counties without NPS units. In the bottom panel, the difference between NPS- and non-NPS-counties from the top panel (calculated as NPS- minus non-NPS) is plotted. Use the drop down menu to change the COVID-19 outcome that is plotted in the panels.")
                                        ),
                                        mainPanel(width=7,
                                                  plotlyOutput("plot5"),
                                                  plotlyOutput("plot8")
...
# Define server 
#the server is the code behind all the things the user sees
